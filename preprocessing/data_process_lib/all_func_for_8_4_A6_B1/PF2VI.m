%% % using  GMM learning PF->dir of V,I (ML course apply here)
    function [Mu_P2VIdir,Sigma_P2VIdir,Priors_P2VIdir,expData_P2VIdir,expSigma_P2VIdir,...
        input_dim_P2VIdir,output_dim_P2VIdir]=PF2VI(pdemos_pos,pdemos_force,pdemos_vel,...
        pdemos_imp,verfy_pdemos_pos,verfy_pdemos_force)
    demos_mix=[pdemos_pos;pdemos_force(2:4,:);pdemos_vel(2:4,:);pdemos_imp(2:4,:)];
    verfine_data=[verfy_pdemos_pos;verfy_pdemos_force(2:4,:)];
    input_dim_P2VIdir=6;
    output_dim_P2VIdir=6;
