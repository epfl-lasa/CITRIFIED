function [Mu Sigma Priors] = gmm_gmr_pos2force_3in(demos,verfine_data,nbStates,scale_f_by_p,scale_i_by_p,ellpsiod_magnitude_GMM,ellpsiod_magnitude_GMM_3D,ellpsiod_magnitude_GMR,ellpsiod_magnitude_GMR_3D)
%
...
%plot 1D
for n=1:nbVar
  subplot(nbVar,2,(n-1)*2+1); hold on;
...
%plot 3D
subplot(nbVar,2,[2:2:2*(nbVar)]); hold on;
...
subplot(nbVar,2,[2:2:2*(nbVar)]); hold on;
plotGMM_3D_P_add_IMP_adj_size(Mu([1,2,3],:), Sigma([1,2,3],[1,2,3],:), [0 .8 0], 5,ellpsiod_magnitude_GMM,ellpsiod_magnitude_GMM_3D);
