    ...
    function [Mu_F2VImagit,Sigma_F2VImagit,Priors_F2VImagit,expData_F2VImagit,...
        ...
        data_std_F2VImagit,MSE] =F2vI_CV_normalize(pdemos_force,pdemos_imp,verfy_pdemos_force,verfy_pdemos_imp,k_GMM,plot_on,normalize)
...
%     k_GMM=3;
    ...
    = gmm_gmr_F2vI_CV(demos_mix,input_dim_F2VImagit,...
