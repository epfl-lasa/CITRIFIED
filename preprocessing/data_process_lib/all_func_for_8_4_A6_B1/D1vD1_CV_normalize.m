    ...
    function [Mu_F2VImagit,Sigma_F2VImagit,Priors_F2VImagit,expData_F2VImagit,...
        ...
        data_std_F2VImagit,MSE] =D1vD1_CV_normalize(pdemos_force,pdemos_imp,...
        input_dir,output_dir,verfy_pdemos_force,verfy_pdemos_imp,k_GMM,plot_on,normalize)
    
%     normalize=1;
    demos_mix=[pdemos_force([1 input_dir],:);pdemos_imp([output_dir],:)];
    verfine_data=[verfy_pdemos_force([1 input_dir],:);verfy_pdemos_imp([output_dir],:)];
...
%     k_GMM=3;
    ...
    = gmm_gmr_D1vD1_CV(demos_mix,input_dim_F2VImagit,...
