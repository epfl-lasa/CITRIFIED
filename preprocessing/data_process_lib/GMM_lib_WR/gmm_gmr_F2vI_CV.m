function [Mu,Sigma,Priors,expData,expSigma,data_mean,data_std,MSE] = gmm_gmr_F2vI_CV(demos,input_dim,output_dim,verfine_data,nbStates,normalize_or_not,ellpsiod_magnitude_GMM,ellpsiod_magnitude_GMM_3D,ellpsiod_magnitude_GMR,ellpsiod_magnitude_GMR_3D,plot_on)
%
...
if normalize_or_not==1
    ...
    mean_output=mean(Data(4:6,:),2);
    std_output=std(Data(4:6,:)');
    ...
    Data2(4:6,:)=(Data(4:6,:)-mean_output)/sqrt(std_output(1)^2+std_output(2)^2+std_output(3)^2);
    ...
    verfine_data(5:7,:)=(verfine_data(5:7,:)-mean_output)/sqrt(std_output(1)^2+std_output(2)^2+std_output(3)^2);
    clear Data1 Data2
