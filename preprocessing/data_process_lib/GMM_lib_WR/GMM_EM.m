...
nbStates = size(Sigma0,3);%http://blog.sina.com.cn/s/blog_51a1df5f0100i3gn.html
loglik_old = -realmax;%return max float value of this system 
nbStep = 0;
...
while 1
  ...
  for i=1:nbStates
    ...
    Pxi(:,i) = GMM_gaussPDF(Data, Mu(:,i), Sigma(:,:,i));
  end
