    ...
    function [Mu_F2VImagit,Sigma_F2VImagit,Priors_F2VImagit,expData_F2VImagit,...
        ...
        data_range_F2VImagit,MSE] =F2mV_CV_normalize(pdemos_force,pdemos_imp,verfy_pdemos_force,verfy_pdemos_imp,k_GMM,plot_on,normalize)
%     normalize=1;
...
%     k_GMM=3;
        ellpsiod_magnitude_GMM=12;ellpsiod_magnitude_GMM_3D=10;
