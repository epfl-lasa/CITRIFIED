...
inline void configureSockets(zmq::context_t& context,
...
template<typename T>
inline bool send(zmq::socket_t& publisher, const T& obj) {
...
template<typename T>
inline bool receive(zmq::socket_t& subscriber, T& obj,
...
template<typename T>
inline bool poll(zmq::socket_t& subscriber, T& obj) {
